...
`},W=D("p",null,[v("Use "),D("code",null,"Rules"),v(" prop to validate the input.")],-1),be={__name:"form-validation",setup(g){return(V,u)=>{const F=z,m=I,i=K,C=G;return w(),y(x,null,{default:o(()=>[l(a,{cols:"12"},{default:o(()=>[l(m,{title:"Simple Form Validation",code:H},{default:o(()=>[W,l(F)]),_:1},8,["code"])]),_:1}),l(a,{cols:"12"},{default:o(()=>[l(m,{title:"Validating Multiple Rules",code:J},{default:o(()=>[l(i)]),_:1},8,["code"])]),_:1}),l(a,{cols:"12"},{default:o(()=>[l(m,{title:"Validation Types",code:Q},{default:o(()=>[l(C)]),_:1},8,["code"])]),_:1})]),_:1})}}};export{be as default};
